...
#define BLUE_SCSI_MAX_WORKING_DIR_LEN 64
...
#define BLUE_SCSI_FILE_MAX_BLOCKS_PER_TRANSFER 16
#define BLUE_SCSI_GET_FILE_BLOCK_SIZE 4096
#define BLUE_SCSI_SEND_FILE_BLOCK_SIZE 512
#define BLUE_SCSI_SEND_FILE_MAX_BYTES (127 * BLUE_SCSI_SEND_FILE_BLOCK_SIZE)
...
class BlueSCSICommand : public SCSICommand {
	public:
		BlueSCSICommand(BPath * path, Logger * logger = NULL);
		~BlueSCSICommand();
